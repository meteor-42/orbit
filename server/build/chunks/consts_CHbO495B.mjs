import { r as removeBase, i as isRemotePath, V as VALID_INPUT_FORMATS, A as AstroError, U as UnknownContentCollectionError, p as prependForwardSlash } from './astro/assets-service_FgzmiciT.mjs';
import { c as createComponent, g as renderUniqueStylesheet, h as renderScriptElement, i as createHeadAndContent, r as renderComponent, a as renderTemplate, u as unescapeHTML } from './astro/server_ckp-fZ9W.mjs';
...
const __vite_import_meta_env__ = {"ASSETS_PREFIX": undefined, "BASE_URL": "/", "DEV": false, "MODE": "production", "PROD": true, "SITE": "https://meteor-42.xyz", "SSR": true};
...
const contentEntryGlob = /* #__PURE__ */ Object.assign({"/src/content/howto/01-vpn/index.md": () => import('./index_DvG9XJc3.mjs'),"/src/content/projects/project-1/index.md": () => import('./index_qmtP1Mex.mjs'),"/src/content/roadmap/vpn.md": () => import('./vpn_DPHOd3LA.mjs')});
...
let lookupMap = {};
lookupMap = {"roadmap":{"type":"content","entries":{"vpn":"/src/content/roadmap/vpn.md"}},"howto":{"type":"content","entries":{"01-vpn":"/src/content/howto/01-vpn/index.md"}},"projects":{"type":"content","entries":{"project-1":"/src/content/projects/project-1/index.md"}}};
...
const renderEntryGlob = /* #__PURE__ */ Object.assign({"/src/content/howto/01-vpn/index.md": () => import('./index_CQkmPMlc.mjs'),"/src/content/projects/project-1/index.md": () => import('./index_BVcc52Ye.mjs'),"/src/content/roadmap/vpn.md": () => import('./vpn_BrdQQKKd.mjs')});
...
export { HOWTO as H, LINKS as L, PROJECTS as P, ROADMAP as R, SITE as S, SEARCH as a, SOCIALS as b, getCollection as g };
